...
import { addIncome, deleteIncome, getIncome, updateIncome } from "../api/financeApi";
...
const CATS = ["Salary", "Freelance", "Gift", "Business", "Other"];
...
export default function Income() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold">{editing ? "Edit Income" : "Add Income"}</h1>
